package com.alienware.scan2shop.services;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void storeReg(String token){
        FirebaseRegManager firebaseRegManager=new FirebaseRegManager(getApplicationContext());
