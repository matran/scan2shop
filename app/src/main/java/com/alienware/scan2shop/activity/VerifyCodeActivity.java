...
public class VerifyCodeActivity extends AppCompatActivity {
            ...
            public void onResponse(JSONObject response){
                ...
                try{
                    ...
                    if (status.equals("success")){
                        Intent intent=new Intent(VerifyCodeActivity.this,VerifyMessageActivity.class);
                        intent.putExtra("phone",phoneno);
                        startActivity(intent);
                        finishAffinity();
                    }else if(status.equals("fail")) {
                        Toast.makeText(getApplicationContext(),"Fail to confirm",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(getApplicationContext(),"Fail to confirm",Toast.LENGTH_LONG).show();
                    }
                }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(VerifyCodeActivity.this,PhoneNumberActivity.class);
        startActivity(intent);
    }
}
